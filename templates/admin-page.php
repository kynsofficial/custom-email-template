...
// Get active tab from query param if available
$active_tab = isset($_GET['tab_id']) ? sanitize_text_field($_GET['tab_id']) : 'general';
...
// SMTP or Default delivery method
$delivery_method = get_option('custom_email_delivery_method', 'default');

// Current view mode - we'll use a query parameter to toggle between settings and preview
$view_mode = isset($_GET['view']) ? sanitize_text_field($_GET['view']) : 'settings';
...
<div class="email-template-settings-app <?php echo $view_mode === 'preview' ? 'preview-mode' : ''; ?>">
    ...
    <div class="email-template-container">
        ...
        <div class="email-template-sidebar">
            <div class="email-template-tabs">
                <ul>
                    <li>
                        <a href="#general" 
                           class="<?php echo ($active_tab === 'general' || empty($active_tab)) ? 'active' : ''; ?>" 
                           data-tab="general">
                    ...
                    <li>
                        <a href="#sender" 
                           class="<?php echo ($active_tab === 'sender') ? 'active' : ''; ?>" 
                           data-tab="sender">
                    ...
                    <li>
                        <a href="#styling" 
                           class="<?php echo ($active_tab === 'styling') ? 'active' : ''; ?>" 
                           data-tab="styling">
                    ...
                    <li>
                        <a href="#smtp" 
                           class="<?php echo ($active_tab === 'smtp') ? 'active' : ''; ?>" 
                           data-tab="smtp">
        ...
        <div class="email-template-content">
            ...
            <div class="view-toggle">
                <a href="?page=custom-email-template<?php echo !empty($active_tab) ? '&tab_id=' . esc_attr($active_tab) : ''; ?>" 
                   class="view-button <?php echo ($view_mode !== 'preview') ? 'active' : ''; ?>">
                    <span class="dashicons dashicons-admin-settings"></span> 
                    Settings
                </a>
                <a href="?page=custom-email-template&view=preview<?php echo !empty($active_tab) ? '&tab_id=' . esc_attr($active_tab) : ''; ?>" 
                   class="view-button <?php echo ($view_mode === 'preview') ? 'active' : ''; ?>">
                    ...
                    <div class="preview-container desktop">
                        <div class="preview-device-frame">
                            ...
                            <div class="preview-device-content" id="email-preview">
                                <?php 
                                // Add extra styles to ensure button is visible with correct colors
                                ...
                                echo $extra_style . $email_template->get_template($sample_content, 'Email Preview'); 
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="preview-container mobile" style="display: none;">
                        <div class="preview-device-frame mobile-frame">
                            ...
                            <div class="preview-device-content mobile-content" id="email-preview-mobile">
                                <?php echo $email_template->get_template($sample_content, 'Email Preview'); ?>
                            </div>
                        </div>
                    </div>
                </div>
            <?php else: ?>
                <!-- Settings mode -->
                <?php
                // Build a custom options form action URL that includes the tab_id
                // We'll preserve the anchor (#) as well so the page reloads at the same tab
                $form_action = 'options.php?tab_id=' . esc_attr($active_tab) . '#' . esc_attr($active_tab);
                ?>
                <form method="post" action="<?php echo esc_url($form_action); ?>" id="email-template-form">
                    <?php settings_fields('custom-email-template-group'); ?>
                    <?php do_settings_sections('custom-email-template-group'); ?>
                    
                    <!-- General Settings Tab Content -->
                    <div id="general" class="settings-tab-content <?php echo ($active_tab === 'general' || empty($active_tab)) ? 'active' : ''; ?>">
                        ...
                        <div class="email-template-field">
                            ...
                            <div class="email-template-field-group">
                                ...
                                <button type="button" class="button" id="upload-logo-button"><?php echo esc_html__('Choose Logo', 'custom-email-template'); ?></button>
                            </div>
                    ...
                    <div id="sender" class="settings-tab-content <?php echo ($active_tab === 'sender') ? 'active' : ''; ?>">
                        ...
                        <div class="email-template-field">
                            ...
                            <div class="email-template-field-group">
                                <input type="text" name="custom_email_avatar_url" id="custom_email_avatar_url" 
                                       ...
                                       class="regular-text preview-update" />
                                <button type="button" class="button" id="upload-avatar-button"><?php echo esc_html__('Choose Image', 'custom-email-template'); ?></button>
                            </div>
                            <div class="email-template-field-note">
                                <?php echo esc_html__('Upload a square image to use as your sender avatar. Note: For Gmail, register this email with Gravatar for avatar support.', 'custom-email-template'); ?>
                    ...
                    <div id="styling" class="settings-tab-content <?php echo ($active_tab === 'styling') ? 'active' : ''; ?>">
                            ...
                            <div class="email-template-color-group">
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_bg_color', '#f7f7f7')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_container_bg_color', '#ffffff')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="email-template-color-group">
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_primary_text_color', '#212327')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_secondary_text_color', '#5b616f')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_footer_text_color', '#9da3af')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="email-template-color-group">
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_header_border_color', '#e0e2ea')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        <input type="text" name="custom_email_footer_border_color" id="custom_email_footer_border_color" 
                                               ...
                                               class="color-input preview-update" data-default-color="#e0e2ea" />
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_footer_border_color', '#e0e2ea')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="email-template-color-group">
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_button_bg_color', '#696cff')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="email-template-field color-field">
                                    ...
                                    <div class="color-picker-container">
                                        <input type="text" name="custom_email_button_text_color" id="custom_email_button_text_color" 
                                               ...
                                               class="color-input preview-update" data-default-color="#ffffff" />
                                        <div class="color-preview" 
                                             style="background-color: <?php echo esc_attr(get_option('custom_email_button_text_color', '#ffffff')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="smtp" class="settings-tab-content <?php echo ($active_tab === 'smtp') ? 'active' : ''; ?>">
...
<!-- Script that updates the form action whenever a user switches tabs,
     so that the #anchor remains consistent across refreshes. -->
<script type="text/javascript">
jQuery(document).ready(function($) {
    $('.email-template-tabs a').on('click', function() {
        var tabId = $(this).data('tab');
        var baseAction = $('#email-template-form').attr('action').split('#')[0]; 
        // attach '#' + tabId to preserve anchor for page reload
